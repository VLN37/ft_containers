...
int main(void) {
  ...
  STRINT_TREE::reverse_iterator itrev1;
  STRINT_TREE::reverse_iterator itrev2(itrev1);
  STRINT_TREE::reverse_iterator itrev3(tree4.getroot());
  STRINT_TREE::const_reverse_iterator itrevc(tree4.getroot());
  itrev1 = tree4.rbegin();
  itrev2 = tree4.rend();
  ...
  std::cout << (itrev1 != itrevc) << '\n';
  STRINT_TREE::reverse_iterator itrev4(itc2);
  std::cout << (itrev4 == itc2) << '\n';
  STRINT_TREE::const_reverse_iterator itrev5(tree4.begin());
  STRINT_TREE::const_reverse_iterator itrev6(tree4.rbegin());
  STRINT_TREE::const_reverse_iterator itrev7(tree4.end());
  STRINT_TREE::const_reverse_iterator itrev8(tree4.rend());
